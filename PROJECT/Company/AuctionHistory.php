...
<?php
$i=0;
$selQry="select * from tbl_lot l inner join tbl_auctionhead a on l.company_id=a.company_id inner join tbl_trader t on l.trader_id=t.trader_id where l.company_id=".$_SESSION['cid'];
