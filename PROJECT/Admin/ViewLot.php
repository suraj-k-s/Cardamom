...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">Lot Details</h1>
        <br><br>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th style="text-align:center">Litre Weight</th>
                    <th style="text-align:center">Quantity</th>
                    <th style="text-align:center">Bag</th>
                    <th style="text-align:center">Planter Name</th>
                    ...
                    <th style="text-align:center">Quality Details</th>
			...
			<?php
				...
				$i=0;
			$selQry="select * from tbl_lot l inner join tbl_company c on l.company_id=c.company_id";
$result=$conn->query($selQry);
  ...
  <tr>
    ...
    <td><a href="../Assets/Files/Lotphoto/<?php echo $row['lot_photo'] ?>" >
      <img src="../Assets/Files/Lotphoto/<?php echo $row['lot_photo'] ?>" height="50px" width="50px" /></a></td>
    <td><?php echo $row['lot_qualitydetails'] ?></td>
    <td><?php echo $row['lot_minimumamount'] ?></td>
    <td><a href="AddDetails.php?lid=<?php echo $row['lot_id'] ?>">Add Details</a></td>
                            ...
                            "buttons": [
                                {
                                    ...
                                    pageSize: 'A3', //A3 , A4 , A5 , A6 , legal , letter
                                    exportOptions: {
                                        columns: ':visible',
                                        search: 'applied',
                                        order: 'applied'
